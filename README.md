...
[![SkillIcons](https://skillicons.dev/icons?i=androidstudio,angular,bootstrap,c,cpp,css,express,firebase,git,html,dart,java,js,linux,mongodb,mysql,nodejs,php,vuejs,py,spring,chartjs,googlecloud,mysql,react,reactnative,vuetify,figma,symfony&perline=6)](https://skillicons.dev)
